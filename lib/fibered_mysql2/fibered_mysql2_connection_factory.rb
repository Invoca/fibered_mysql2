  ...
  module ActiveRecord
    ...
    if ::ActiveRecord.gem_version < "7.1"
      module Adapter_4_2
        ...
        EMTransactionManager = TransactionManager
        class TransactionManager < EMTransactionManager
          ...
          def begin_transaction(isolation: nil, joinable: true, _lazy: true)
            @connection.lock.synchronize do
              ...
              transaction =
                if _current_stack.empty?
                ...
                elsif ActiveRecord.gem_version >= "7.1" && current_transaction.restartable?
                  ...
                  ::ActiveRecord::ConnectionAdapters::SavepointTransaction.new(
                    @connection,
                    "active_record_#{Fiber.current.object_id}_#{open_transactions}",
                    _current_stack.last,
                    isolation:,
                    joinable:,
                    run_commit_callbacks:
              ...
              if ::ActiveRecord.gem_version < "7.1" || !transaction.materialized?
